...
public class EAPIConsts {
    ...
    //	private final static String HOME_URL_DEV = "http://192.168.30.211:8080/";
    private final static String HOME_URL_DEV = "http://120.76.101.90/moxsan/";   //开发环境  http://120.76.101.90:8005/
