...
public  class DateStringUtil
{
    ...
    public static String getNowDateAndWeekForDate(Date date){
        String mYear;
        String mMonth;
        String mDay;
        String mWay;
    ...
    public static String getDisplayForMMDD(String getDateString, Context context, boolean timeZone) {
        Date getDate = null;
        try {
            if (timeZone) {
                getDate = getFormat("yyyy-MM-dd'T'HH:mm:ssZ").parse(getDateString);
    ...
    public static String getDateString(String source, Context context) {
        ...
        if (offsetDay <= 0) {
            dateString = new SimpleDateFormat("今天 HH:mm").format(sourceDate);
            ...
            dateString = new SimpleDateFormat("M月d日 HH:mm").format(sourceDate);
        }
    ...
    public static boolean compareToDate(String oldDate, String defDate) {
        LLog.d("oldDate = " + oldDate + ", defDate" + defDate);
